...
Учебный проект, статичная вёрстка макета из 2-х страниц без использования JavaScript
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/345769-sedona-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
